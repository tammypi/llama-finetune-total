...
def main():
    ...
    parser.add_argument("--model_path", type=str,default = '/root/autodl-tmp/models')
    parser.add_argument("--dataset_path", type=str,default = '/root/autodl-tmp/UMLSE_TOKENIZED')
    parser.add_argument("--save_dir", type=str,default = '/root/autodl-tmp/Fine_Tuning_Results/PMCandMedMCQA_Lora')
    ...
    for step in tqdm.trange(args.num_train_steps, initial=start):
        ...
        if actual_step % args.save_interval == 0:
            ...
            torch.save(opt.state_dict(), os.path.join(args.save_dir, f"opt-{actual_step:06d}.p"))
...
# CUDA_VISIBLE_DEVICES='0,1,2,3' python finetune_pp_peft.py